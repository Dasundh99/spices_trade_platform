...
const TropicalFoods: React.FC = () => {
  ...
  useEffect(() => {
    ...
    columns.forEach((column, index) => {
      // Define speeds as percentages of the gallery container's height
      const speedPercent = [0.2, 0.1, 0.3]; // Example percentages for each column
