...
const SideNavigator = () => {
  ...
  return (
    <div className="flex justify-center w-full">
      <nav className="bg-white backdrop-blur-lg shadow-xxl p-2 rounded-xl mb-10">
            ...
            return (
              <li key={item.path} className="flex justify-center">
                <Link to={item.path} className="group relative block">
                  <div
                    className={`w-42 h-16 flex items-center justify-center rounded-lg shadow-xl transition-colors duration-200 
                      ${
                        isActive
                          ? "bg-green-400 text-white"
                          : "bg-white text-green-400 hover:bg-white/30"
                      }`}
                  >
